...
#Give a group Sparcet automation
  ...
  #browser.window.resize_to(1680,1050)
   browser.current_url
	...
	#Sparcet details
			...
			browser.find_element(id: "give-input-selectize").send_keys "prashant.katwa"
			sleep(5)
			browser.find_element(id: "give-input-selectize").send_keys :tab
		...
		#Badge select
			browser.find_element(xpath: "//*[@id='fullscreen-views']/div/div/form/fieldset[1]/div[1]").click 

		#Sparcet Reason and Thanks message; send click
			browser.find_element(id: "reason").send_keys "This Group Sparcet was sent through automation"
			 browser.find_element(name: "thanksMessage").send_keys "Automated Group Sparcet"
